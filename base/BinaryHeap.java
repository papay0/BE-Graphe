...
public class BinaryHeap<E extends Comparable<E>> {
    ...
    private HashMap <E, Integer> map; // ma map va être :
    /*
        Key : mon Element
        Value : l'index de l'element dans le tableau ArrayList
        Pourquoi ? Pour pouvoir récupérer en un temps presque constant la position de mon Element dans mon array,
        lors de l'utilisation de la fonction update.
    */
